...
UNITY_LOCATION(0) uniform mediump sampler2D _TextureRGB;
...
void main()
{
    ...
    u_xlat16_1 = texture(_TextureRGB, vs_TEXCOORD0.xy);
...
void main()
{
    ...
    u_xlat16_0 = texture(_TextureRGB, vs_TEXCOORD0.xy);
...
uniform 	mediump float _Transparency;
UNITY_LOCATION(0) uniform mediump sampler2D _TextureRGB;
UNITY_LOCATION(1) uniform mediump sampler2D _TextureA;
in mediump vec2 vs_TEXCOORD0;
layout(location = 0) out mediump vec4 SV_Target0;
...
void main()
{
    u_xlat16_0.x = texture(_TextureA, vs_TEXCOORD0.xy).x;
    u_xlat16_1 = (-_Transparency) + 1.0;
    SV_Target0.w = u_xlat16_0.x * u_xlat16_1;
    u_xlat16_0.xyz = texture(_TextureRGB, vs_TEXCOORD0.xy).xyz;
    SV_Target0.xyz = u_xlat16_0.xyz;
    return;
}
...
void main()
{
    ...
    SV_Target0.w = u_xlat16_3 * u_xlat16_1;
    u_xlat16_0.xyz = texture(_TextureRGB, vs_TEXCOORD0.xy).xyz;
    SV_Target0.xyz = u_xlat16_0.xyz;
    return;
}
