...
void main()
{
    ...
    u_xlat16_0.w = texture(_MainTex, u_xlat1.xy).y;
    SV_Target0 = u_xlat16_0;
    return;
}
...
void main()
{
    ...
    u_xlat16_0.yz = texture(_SecondTex, vs_TEXCOORD0.xy).xy;
    u_xlat0.xyz = u_xlat16_0.xyz * vec3(64.0615845, 64.0615845, 64.0615845) + vec3(-0.0625, -0.5, -0.5);
