...
UNITY_LOCATION(1) uniform mediump sampler2D _FadeTex;
...
;
    ...
    u_xlat16_1 = texture(_FadeTex, vs_TEXCOORD1.xy);
    u_xlat1 = u_xlat16_1 + _TextureSampleAdd;
    u_xlat16_2 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat2 = u_xlat16_2 + _TextureSampleAdd;
    u_xlat16_3.x = u_xlat1.w + (-u_xlat2.w);
    u_xlat16_8.xyz = u_xlat1.www * u_xlat1.xyz;
    u_xlat16_3.x = _Strength * u_xlat16_3.x + u_xlat2.w;
    u_xlat16_4.xyz = u_xlat2.www * u_xlat2.xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * vs_COLOR0.www;
    u_xlat16_3.x = (-u_xlat16_3.x) * vs_COLOR0.w + 1.0;
    u_xlat0.x = u_xlat0.x * u_xlat16_3.x;
    SV_Target0.w = u_xlat0.x;
    u_xlat16_3.xyz = u_xlat16_8.xyz * vs_COLOR0.www + (-u_xlat16_4.xyz);
    u_xlat16_3.xyz = vec3(_Strength) * u_xlat16_3.xyz + u_xlat16_4.xyz;
...
;
    ...
    u_xlat16_4.xyz = u_xlat16_4.xyz * vs_COLOR0.www;
    u_xlat16_3.x = (-u_xlat16_3.x) * vs_COLOR0.w + 1.0;
    u_xlat16_19 = u_xlat16_3.x * u_xlat0.x + -0.00100000005;
    u_xlat0.x = u_xlat0.x * u_xlat16_3.x;
    SV_Target0.w = u_xlat0.x;
#ifdef UNITY_ADRENO_ES3
    u_xlatb0.x = !!(u_xlat16_19<0.0);
#else
    u_xlatb0.x = u_xlat16_19<0.0;
#endif
