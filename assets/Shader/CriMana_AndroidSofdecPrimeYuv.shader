...
void main()
{
    ...
    u_xlat16_0.y = texture(_TextureU, vs_TEXCOORD1.xy).x;
    u_xlat16_0.z = texture(_TextureV, vs_TEXCOORD1.xy).x;
...
void main()
{
    u_xlat16_0.x = texture(_TextureA, vs_TEXCOORD2.xy).x;
    u_xlat16_1.x = (-_Transparency) + 1.0;
...
{
    u_xlat16_0.x = texture(_TextureY, vs_TEXCOORD0.xy).x;
    u_xlat16_0.yz = texture(_TextureUV, vs_TEXCOORD1.xy).xw;
    u_xlat16_1.xyz = u_xlat16_0.xyz + vec3(-0.0627499968, -0.50195998, -0.50195998);
    SV_Target0.x = dot(vec2(1.16437995, 1.59603), u_xlat16_1.xz);
    SV_Target0.y = dot(vec3(1.16437995, -0.391759992, -0.812969983), u_xlat16_1.xyz);
    SV_Target0.z = dot(vec2(1.16437995, 2.01723003), u_xlat16_1.xy);
...
SubProgram "gles3 hw_tier00 " {
Keywords { "CRI_LINEAR_COLORSPACE" "CRI_UV_FORMAT" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "CRI_APPLY_TARGET_ALPHA" "CRI_UV_FORMAT" }
"#ifdef VERTEX
#version 300 es
...
void main()
{
    u_xlat16_0.x = (-_Transparency) + 1.0;
    SV_Target0.w = u_xlat16_0.x * vs_COLOR0.w;
    u_xlat16_1.x = texture(_TextureY, vs_TEXCOORD0.xy).x;
    u_xlat16_1.yz = texture(_TextureUV, vs_TEXCOORD1.xy).xw;
    u_xlat16_0.xyz = u_xlat16_1.xyz + vec3(-0.0627499968, -0.50195998, -0.50195998);
    SV_Target0.x = dot(vec2(1.16437995, 1.59603), u_xlat16_0.xz);
    SV_Target0.y = dot(vec3(1.16437995, -0.391759992, -0.812969983), u_xlat16_0.xyz);
    SV_Target0.z = dot(vec2(1.16437995, 2.01723003), u_xlat16_0.xy);
    return;
}
...
SubProgram "gles3 hw_tier00 " {
Keywords { "CRI_APPLY_TARGET_ALPHA" "CRI_LINEAR_COLORSPACE" "CRI_UV_FORMAT" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "CRI_ALPHA_MOVIE" "CRI_UV_FORMAT" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "CRI_ALPHA_MOVIE" "CRI_LINEAR_COLORSPACE" "CRI_UV_FORMAT" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "CRI_ALPHA_MOVIE" "CRI_APPLY_TARGET_ALPHA" "CRI_UV_FORMAT" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "CRI_ALPHA_MOVIE" "CRI_APPLY_TARGET_ALPHA" "CRI_LINEAR_COLORSPACE" "CRI_UV_FORMAT" }
"#ifdef VERTEX
#version 300 es
