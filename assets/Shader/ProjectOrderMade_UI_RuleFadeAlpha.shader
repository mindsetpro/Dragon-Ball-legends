...
//
///////////////////////////////////////////
Shader "ProjectOrderMade/UI/RuleFadeAlpha" {
Properties {
...
;
    ...
    u_xlat16_4 = u_xlat16_1 * u_xlat2.x + -0.00100000005;
    u_xlat0.w = u_xlat16_1 * u_xlat2.x;
    SV_Target0 = u_xlat0;
#ifdef UNITY_ADRENO_ES3
...
;
    ...
    u_xlat3.x = u_xlat16_3 + _TextureSampleAdd.w;
    ...
    u_xlat16_4.x = (-u_xlat2.w) * vs_COLOR0.w + 1.0;
    ...
    SV_Target0.xyz = u_xlat3.xyz * u_xlat16_1.xyz;
    return;
}
