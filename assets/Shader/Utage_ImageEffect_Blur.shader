...
void main()
{
    ...
    u_xlat16_0 = vec4(u_xlat16_2) * vec4(0.0, -3.0, 0.0, 3.0) + in_TEXCOORD0.xyxy;
    u_xlat0 = u_xlat16_0 * _MainTex_ST.xyxy + _MainTex_ST.zwzw;
    vs_TEXCOORD1 = u_xlat0;
    u_xlat16_0 = vec4(u_xlat16_2) * vec4(0.0, -2.0, 0.0, 2.0) + in_TEXCOORD0.xyxy;
    u_xlat16_1 = vec4(u_xlat16_2) * vec4(0.0, -1.0, 0.0, 1.0) + in_TEXCOORD0.xyxy;
...
void main()
{
    ...
    u_xlat16_0 = vec4(u_xlat16_2) * vec4(-3.0, 0.0, 3.0, 0.0) + in_TEXCOORD0.xyxy;
    u_xlat0 = u_xlat16_0 * _MainTex_ST.xyxy + _MainTex_ST.zwzw;
    vs_TEXCOORD1 = u_xlat0;
    u_xlat16_0 = vec4(u_xlat16_2) * vec4(-2.0, 0.0, 2.0, 0.0) + in_TEXCOORD0.xyxy;
    u_xlat16_1 = vec4(u_xlat16_2) * vec4(-1.0, 0.0, 1.0, 0.0) + in_TEXCOORD0.xyxy;
    u_xlat1 = u_xlat16_1 * _MainTex_ST.xyxy + _MainTex_ST.zwzw;
    vs_TEXCOORD3 = u_xlat1;
    u_xlat0 = u_xlat16_0 * _MainTex_ST.xyxy + _MainTex_ST.zwzw;
    vs_TEXCOORD2 = u_xlat0;
