...
//
///////////////////////////////////////////
Shader "SCREAM/StoryDemo/ImageMaskShader" {
Properties {
_MainTex ("MainTexture", 2D) = "clear" { }
_Color ("Tint", Color) = (1,1,1,1)
_MaskTex ("Alpha mask (R)", 2D) = "white" { }
}
SubShader {
 LOD 100
...
void main()
{
    u_xlat16_0.x = texture(_MaskTex, vs_TEXCOORD1.xy).w;
    u_xlat16_1 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_2 = min(u_xlat16_0.x, u_xlat16_1.w);
    u_xlat16_0.xyz = u_xlat16_1.xyz + _TextureSampleAdd.xyz;
    u_xlat16_0.w = u_xlat16_2 + _TextureSampleAdd.w;
...
;
    ...
    u_xlat16_3 = texture(_MaskTex, vs_TEXCOORD1.xy).w;
    u_xlat16_1 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_2 = min(u_xlat16_3, u_xlat16_1.w);
    u_xlat16_1.xyz = u_xlat16_1.xyz + _TextureSampleAdd.xyz;
    u_xlat16_1.w = u_xlat16_2 + _TextureSampleAdd.w;
