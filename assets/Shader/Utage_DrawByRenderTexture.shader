...
;
    ...
    u_xlat16_2.x = (-u_xlat16_2.x) * vs_COLOR0.w + 1.0;
    u_xlat0.x = u_xlat0.x * u_xlat16_2.x;
    SV_Target0.w = u_xlat0.x;
    u_xlat16_2.xyz = vs_COLOR0.www * vs_COLOR0.xyz;
...
SubProgram "gles3 hw_tier00 " {
Keywords { "CROSS_FADE" "UNITY_UI_ALPHACLIP" }
"#ifdef VERTEX
#version 300 es
